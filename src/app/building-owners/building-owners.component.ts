...
export class BuildingOwnersComponent implements OnInit {
  ...
  bouncedChartData() {
    this.bounced_ChartData = this.appComponent.bouncedChartData(this.buildingOwners);
  }

  freqChartData() {
    this.freq_ChartData = this.appComponent.freqChartData(this.buildingOwners);
  }

  sentTodayChartData() {
    this.sentToday_ChartData = this.appComponent.sentTodayChartData(this.buildingOwners);
  }

  sentWeekChartData() {
    this.sentWeek_ChartData = this.appComponent.sentWeekChartData(this.buildingOwners);
  }

  sentMonthChartData() {
    this.sentMonth_ChartData = this.appComponent.sentMonthChartData(this.buildingOwners);
  }
